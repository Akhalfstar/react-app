...
function Footer() {
  return (
    <>
      <div>
        <div className=" w-screen bg-gray-400 my-2 h-px" ></div>
        <div className="flex px-5 md:px-30 justify-between  h-40">
          ...
          <div className=" w-1/2 h-full flex justify-between items-center">
            <ul className="flex flex-col gap-3.5">
              <li className=" uppercase mb-2 font-bold text-xs">Resources</li>
            ...
            <ul className="flex flex-col gap-3.5">
              <li className=" uppercase mb-2 font-bold text-xs">Legel</li>
              <li className="text-sm font-medium">Privacy Policy</li>
              <li className="text-sm font-medium">Term & Conditions</li>
            </ul>
          </div>
        </div>
        <div className=" w-screen bg-gray-300 my-2 h-px" ></div>
