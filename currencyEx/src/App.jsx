  ...
  return (
    <>
      <div className=" flex flex-col h-screen justify-center items-center text-2xl text-white ">
        ...
        <button
          onClick={swp}
          className=" border-amber-200 text-2xl px-4 py-2 border-2 rounded-sm bg-amber-900 -m-2.5 z-2 cursor-pointer "
        >
          {" "}
          SWAP{" "}
        </button>
        ...
        <button
          onClick={convert}
          className=" text-xl font-medium px-4 py-2 m-2 bg-green-400 rounded-md cursor-pointer "
        >
          Convert
        </button>
      </div>
